...
const EditTestModal = ({ isOpen, onClose, test, onUpdated }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const errorMsg = error.response?.data?.error || "Failed to update test";
      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full flex flex-col max-h-[90vh] overflow-hidden animate-in fade-in zoom-in duration-200">
        ...
        <div className="px-6 py-3 bg-gradient-to-r from-gray-50 to-gray-100 border-b flex items-center gap-4">
          ...
          <div className="ml-auto text-sm text-gray-600">
            <span className="font-medium">{formData.duration}</span> min
          </div>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 hover:border-gray-300 transition-all font-medium"
                >
