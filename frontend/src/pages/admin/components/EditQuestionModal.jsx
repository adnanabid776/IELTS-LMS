      ...
      <div className="bg-white rounded-lg shadow-xl max-w-3xl w-full my-8">
        ...
        >
          <div className="space-y-4">
            ...
            {/* Word limit / Allow number (Hidden for Matching types, Table Completion, Subjective, and MC-Multi) */}
            {formData.questionType !== "matching-headings" &&
              formData.questionType !== "matching-information" &&
              formData.questionType !== "map-labeling" &&
              formData.questionType !== "table-completion" &&
                    ...
                    {formData.options.map((option, index) => {
                      ...
                      return (
                        <div key={index} className="flex gap-2 items-center">
                          ...
                          <div className="flex-shrink-0 w-8 h-8 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg flex items-center justify-center font-bold text-sm">
                            {letter}
                          </div>
                          <input
                            type="text"
            ...
            {/* Correct Answer (Hidden for MC-Multi which uses checkboxes) */}
            {formData.questionType !== "matching-headings" &&
              formData.questionType !== "matching-information" &&
              formData.questionType !== "map-labeling" &&
              formData.questionType !== "matching-features" &&
